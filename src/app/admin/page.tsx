    ...
    <main className={styles.page}>
      ...
      <section className={styles.grid}>
        <article className={styles.card}>
          ...
          <p>Progression, preuves d&apos;ecoute, quiz, derniere activite et export CSV Qualiopi.</p>
        ...
        <article className={styles.card}>
          <div className={styles.cardHeader}>
            <h2>Gestion</h2>
            <span className={styles.tag}>Manuel</span>
          </div>
          <p>
            Gerer les societes, les releases, les scripts, les quiz, les audios MP3
            et les assignations apprenants.
          </p>
